...
const NavBar = () => {
    ...
    return (
        <>
            <div className="flex flex-row justify-between w-full items-center gap-2 p-1 bg-[#424068]  transition duration-300 ease-in-out mb-2">
                <div className="flex flex-row items-center">
                    {links.map((link, index) => (
                        <Link
                            key={index}
                            className="text-white rounded-sm text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl p-2 font-extrabold hover:underline transition duration-300 ease-in-out"
                            to={link.path}
                        >
                            {link.name}
                        </Link>
                ...
                <div className="relative">
                    <button onClick={handleShowDropdown} className="rounded-full p-2 ">
